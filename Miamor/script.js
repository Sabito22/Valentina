...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 5:
            ...
            document.getElementById('noBtn').innerHTML = 'Solo piensa un poco';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 16:
                document.getElementById('noBtn').innerHTML = 'por favooooooor... Aqui ya tienes que presionar que Si';
                document.getElementById('noBtn').style.backgroundColor = '#F1330A';
